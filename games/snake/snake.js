...
var lastDown = 39;	//start out moving to the right
var prevDown = null;    //used to prevent going backwards
var newGame = true;
var paused = false;
var objectHit = null;
...
snakeImage.src = "media/snake.png";
...
appleImage.src = "media/snake.png";
...
function newApple() {
    apple.x = Math.floor(Math.random() * 20)*16;
    apple.y = Math.floor(Math.random() * 20+1)*16;
    
    //prevent spawning on the snake
    var coll = true;
    while(coll)
    {
...
function update(modifier) {
    ...
    //TODO body collision occurs when food is eaten
